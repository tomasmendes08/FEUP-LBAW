...
<section class="recover-password mt-5">
    ...
    <div class="footer d-flex justify-content-center">
        <button type="button" onclick="location.href='/'" id="login_email" class="btn btn-primary w-50" style="background-color: #212529; border-color: #212529;">Change Password</button>
    </div>
    <div class="row mt-3">
    ...
    <div class="row my-3 d-flex justify-content-center">
        <button type="button" onclick="location.href='/signup'" id="login_google" class="btn btn-lg btn-outline-primary w-75 fs-5" style="color: #212529; border-color: #212529;">
