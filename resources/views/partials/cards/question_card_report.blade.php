<div class="question-card-container-{{$question->question_id}} col-12 mt-4">
    <div class="card mb-4 " style="border: solid 1px #212529;">
        ...
        <div class="card-footer d-flex align-items-center">
            ...
            <div class="question-options dropup">
                <span class="material-icons more-options me-1" data-bs-toggle="dropdown" aria-expanded="false">
                    more_horiz
                </span>
                <div class="question-options-buttons dropdown-menu" data-id="{{$question->question_id}}" style="border: 2px solid;">
                    <button type="button"
                            class="btn d-flex mt-1 delete-question-button-reports"
                            style="border: 0px;"
                    ...
                    <button type="button"
                            class="btn d-flex mt-1 unreport-question-button-reports"
                            style="border: 0px;"
                            data-id="{{$question->question_id}}">
                        <span class="material-icons delete-icon me-2">
                            flag
